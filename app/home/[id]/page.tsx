...
import { CaegoryShowcase } from "@/app/properties/components/CategoryShowcase";
        ...
        <div className="w-2/3">
          ...
          <div className="flex items-center mt-6">
            ...
            <div className="flex flex-col ml-4">
              <h3 className="font-medium">Publie par {data?.User?.firstName}</h3>
              <p className="text-sm text-muted-foreground">Hote depuis 2 mois</p>
            </div>
          </div>
